...
##Fig 5i: Neu nuclei percentage (Neu = EN + IN + Neu_Early)
...
## =============================================================================
## Panel m correlation: highlight putative noncoding RNAs
## =============================================================================
...
## -----------------------------------------------------------------------------
## 4) Panel m plot: highlight putative noncoding RNAs (same plotting logic)
## -----------------------------------------------------------------------------
df2_plot <- df2 %>%
  mutate(
    gene = as.character(gene),
